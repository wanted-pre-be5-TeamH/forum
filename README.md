...
| 게시판 목록 조회      | ✅   | GET /board        | ❌             |
| 게시판 생성           | ✅   | POST /board       | ✅             |
| 게시판 상세 정보 조회 | ✅   | GET /board/:id    | ✅             |
| 게시판 정보 수정      | ❌   | PATCH /board/:id  | ✅             |
| 게시판 삭제           | ✅   | DELETE /board/:id | ✅             |

### 게시물

| 내용                  | 상태 | API                       | 인증 정보 필요 |
| --------------------- | ---- | ------------------------- | -------------- |
| 게시물 목록 조회      | ❌   | GET /board/:id/post       | ✅             |
| 게시물 생성           | ❌   | POST /board/:id/post      | ✅             |
| 게시물 상세 정보 조회 | ❌   | GET /board/:id/post/:id   | ✅             |
| 게시물 수정           | ❌   | PATCH /board/:id/post/:id | ✅             |
| 게시물 삭제           | ❌   | DELETE /board/:id/post:id | ✅             |
